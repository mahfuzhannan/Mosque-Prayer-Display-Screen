  ...
  return (
    <div className="w-full bg-white ">
      <table className="w-full table-auto">
        <thead className="font-semibold bg-mosqueBrand-primaryAlt/80 text-white">
...
function CalendarRow({ prayer_time }: { prayer_time: CalendarDailyPrayerTime }) {
  ...
  const congregationClassNames = `text-lg text-center bg-mosqueBrand-highlight/30 ${isFriday ? "font-semibold border-b-2 border-mosqueBrand-primary" : ""}`
